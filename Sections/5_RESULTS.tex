...
% ADD INTRO + say why these results are brief (we will step through the findings in detail and discuss their associated importance in the next Part.
...
For completeness, the most cited law journal articles are Gray's `Property in Thin Air' in the \textit{Cambridge Law Journal} and Salmond's `Citizenship and Allegiance' in the \textit{Law Quarterly Review} (n=$14$).\xn{5-4} Of the $1331$ cited articles, $885$ are only cited once and $1133$ are cited twice or less. Only $196$ articles are cited at least twice. The \emph{mean} number of citations is $7.29$, with a standard deviation of $12.28$.
...
Comparatively, texts are cited heavily by the High Court, with a \emph{mean} of $48.37$ citations and a standard deviation of $367.29$.\xn{5-5} By far, the most cited treatise is \textit{Cross on Evidence}, cited $2893$ times directly and $2592$ times indirectly.\xn{5-6} Maitland's  \textit{Equity} trails comfortably behind, with $675$ direct and $1180$ indirect citations.\xn{5-7} The only author to appear in the top $20$ cited journals and texts is Oliver W. Holmes. In respect of the latter, Holmes is cited exclusively for his seminal text \textit{The Common Law}.\xn{5-8}
...
% Sheehy and Dumay Sydney Law Review is the most cited journal by the High Court of Australia, however, this is not so. see also ALJ ``current issues'' (1998) 72 ALJ 249
